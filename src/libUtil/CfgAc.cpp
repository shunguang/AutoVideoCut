...
void CfgAc::fromPropertyTree(const boost::property_tree::ptree &pt0)
{
	...
	m_log.isShowLogInConsole = (bool)pt.get<uint8>("isShowLogInConsole");
...
boost::property_tree::ptree CfgAc::toPropertyTree()
{
	...
	pt.put("cfg.log.isShowLogInConsole", (uint8)m_log.isShowLogInConsole);
	...
	pt.put("cfg.dataContainer.qSize", m_dc0.qSize);
